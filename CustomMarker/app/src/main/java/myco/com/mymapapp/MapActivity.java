...
public class MapActivity extends Activity {
    ...
    private void loadVenueAndMap(final String venueId, final String venueName) {
        ...
        listeners.loadCompletedListener = new VenueDatabase.OnLoadCompletedListener() {
            @Override
            public void onLoadCompleted(Venue venue, Map _map, MapView _mapView, Floor floor, Marker marker) {
                ...
                mapView.setOnReadyListener(new MapView.OnReadyListener() {
                    ...
                    public void onReady() {
                        ...
                        // Add marker for the Starbucks close to Gate 60
                        LatLng latLng = new LatLng(33.942200, -118.402038);
                        Position position = new Position(null, "lax", "lax-south", "lax-south-departures", null, null, latLng, 0.0, 0.0 , null, false);

                        Marker.Options options = new Marker.Options();
                        options.position(position);
                        options.icon("images/starbucks_selected.svg");
                        options.clickable(true);
                        map.addMarker(options);

                        // Make the marker clickable
                        map.setOnMarkerClickedListener(new Map.OnMarkerClickedListener() {
                            @Override

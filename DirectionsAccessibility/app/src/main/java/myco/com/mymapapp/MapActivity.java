...
public class MapActivity extends Activity {
    ...
    private void loadVenueAndMap(final String venueId, final String venueName) {
        ...
        listeners.loadCompletedListener = new VenueDatabase.OnLoadCompletedListener() {
            ...
            public void onLoadCompleted(Venue _venue, Map map, MapView _mapView, Floor floor, Marker marker) {
                ...
                requestWheelchairDirectionsAndETAProgrammatically();
            }
        };
    ...
    private void requestWheelchairDirectionsAndETAProgrammatically() {

        LatLng point1LatLon = new LatLng(33.940627, -118.401892);
        LatLng point2LatLon = new LatLng(33.9410700, -118.399598);

        Position positionStart = new Position(null, "lax", "lax-south", "lax-south-departures", null, 0, point1LatLon, 0.0, 0.0);
        Position positionEnd = new Position(null, "lax", "lax-south", "lax-south-departures", null, 0, point2LatLon, 0.0, 0.0);

        venue.getNavigationAccessibleSegments(mapView, positionStart, positionEnd, new Venue.OnGetNavigationSegmentsListener() {
            @Override
        ...
        }, new Venue.OnGetNavigationSegmentsFailureListener() {
            @Override
            public void onGetNavigationSegmentsFailure(String s) {
                Log.d("MapActivity", "Segments Error");
            }
        });
    }
}
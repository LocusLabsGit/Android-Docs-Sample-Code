...
public class MapActivity extends AppCompatActivity {
            ...
            public void onLoadCompleted(Airport _airport, Map _map, final MapView _mapView, Floor floor, Marker marker) {
                ...
                mapView.setOnReadyListener(new MapView.OnReadyListener() {
                    ...
                    public void onReady() {
                        ...
                        // POI 1007 is the Earthbar near gate 65B at LAX
                        mapView.showPoiPopup("1007");
                    }
                });
            }
        };
    ...
    private void setupPhoneTapListener() {

        mapView.setOnPoiPhoneClickedListener(new MapView.OnPoiPhoneClickedListener() {
            @Override
            public void onPoiPhoneClicked(String s) {

                // Handle the passed in phone number
            }
        });
    }

    private void setupURLTapListener() {

        mapView.setOnPoiUrlClickedListener(new MapView.OnPoiUrlClickedListener() {
            @Override
            public void onPoiUrlClicked(String s) {

                    // Handle the passed in URL
            }
        });
    }
}